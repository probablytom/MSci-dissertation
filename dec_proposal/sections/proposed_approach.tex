...
We can see that the literature available, while not on computational responsibility formalisms, is all fairly related to constructing the formalism proposed. In light of this, we can begin to identify some of the components of a suitable formalism:\par

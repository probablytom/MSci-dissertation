...
\subsection{Ian Sommerville, Sociotechnical Systems, and Responsibility Modelling}\todo{Finish discussing Sommerville's contribution to the state of the art.}
...
In the proposed approach in the following section, we will explore possible formalisms of responsibility which leverage ideas from all of these useful insights from related literature, in order to better answer the research questions laid out.\par

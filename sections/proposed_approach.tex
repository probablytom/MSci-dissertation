...
\begin{center}
    ...
    \begin{tabular}{p{10cm}|c}
      ...
      \end{tabular}
      \caption{A list of variables Marsh produces for his trust formalism.}
    \end{table}
    \begin{table}
    \begin{tabular}{p{10cm}|c}
    ...
    \caption{A list of variables similar to Marsh's that the similarities between responsibility and trust might permit.}
    \end{tabular}
    \end{table}
\end{center}

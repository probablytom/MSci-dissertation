...
Obligations are sets of constraints --- they therefore allow constraints to be composed together. Obligations may only concern themselves with a single constraint, and have no upper limit on their size. Obligations therefore represent the total state change a responsibility concerns, and serves as a specification of this change.\par

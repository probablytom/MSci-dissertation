...
Following this introduction, the second section of this report focuses on exploring the problem domain, and making concrete the research questions which this report will address.\par
...
Computational formalisms of human traits are a growing field of research, with applications in lots of different areas. A problem with these anthropomorphic algorithms is that there is limited breadth to the existing research in the field (as is demonstrated during the background survey in \cref{sec:related_work}).\par

Breadth in the application of the metaphor is important, however. The importance stems from the utility of the human metaphor when designing systems:
